namespace ImVaderUnitTests
{
    ...
    public class MatrixGraphTest
    {
        ...
        {
            var m = new MatrixGraph<int, Edge>();
        ...
        {
            var m = new MatrixGraph<int, Edge>(10);
            Assert.AreEqual(0, m.EdgesCount);
        ...
        {
            var m = new MatrixGraph<int, WeightedEdge>(10);
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                edge.Weight += 2;
                Assert.AreEqual(i + 4.2, m.GetEdge(edgeIndex).Weight);
            }
